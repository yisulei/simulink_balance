...
MODEL                = angle_led
MODULES              = StackLiteDualDrive_Input.c StackLiteDualDrive_Output.c angle_led_data.c main.c
MAKEFILE             = angle_led.mk
MATLAB_ROOT          = D:\software\MATLAB2021b
ALT_MATLAB_ROOT      = D:\software\MATLAB2021b
MATLAB_BIN           = D:\software\MATLAB2021b\bin
MASTER_ANCHOR_DIR    = 
START_DIR            = D:\BaiduSyncdisk\000IFR\2022Balance\model\Task1\angle_led
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
NUMST                = 1
TID01EQ              = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)\angle_led_stm32_rtw \
	-I$(MATLAB_ROOT)\extern\include \
	-I$(MATLAB_ROOT)\simulink\include \
	-I$(MATLAB_ROOT)\rtw\c\src \

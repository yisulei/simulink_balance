 ...
 * C/C++ source code generated on : Fri Feb 24 14:50:35 2023
 *
...
void StandSpeed_Balance_step(void)
{
  ...
  DataLink_UpFrameData.data[5].point= StandSpeed_Balance_B.DataStoreRead8;
  DataLink_UpFrameData.data[6].point= StandSpeed_Balance_B.DataStoreRead10;
  DataLink_UpFrameData.data[7].point= StandSpeed_Balance_B.DataTypeConversion4;
  ...
  if (StandSpeed_Balance_DW.Output_DSTATE_a == 1) {
     ...
     *  Sum: '<S33>/Add2'
     */
    StandSpeed_Balance_DW.Delay_DSTATE_f = (StandSpeed_Balance_B.DataStoreRead4
      - (StandSpeed_Balance_B.Divide + StandSpeed_Balance_B.Divide1)) * 0.3F +
      0.7F * StandSpeed_Balance_DW.Delay_DSTATE_f;
     ...
     *  Delay: '<S36>/Delay'
     *  Gain: '<S35>/Gain'
     *  ManualSwitch: '<S35>/Manual Switch1'
     *  Product: '<S35>/Product3'
     *  Sum: '<S35>/Add2'
     */
    StandSpeed_Balance_DW.Delay_DSTATE_j = ((real32_T)(0.001 *
      StandSpeed_Balance_DW.Ki_speed * StandSpeed_Balance_DW.Delay_DSTATE_f) +
      StandSpeed_Balance_DW.Delay_DSTATE_j) * 0.995;

    /* Saturate: '<S35>/Saturation2' */
    if (StandSpeed_Balance_DW.Delay_DSTATE_j > 20.0) {
      /* Gain: '<S35>/Gain1' */
      StandSpeed_Balance_DW.Delay_DSTATE_j = 20.0;
    } else if (StandSpeed_Balance_DW.Delay_DSTATE_j < -20.0) {
      /* Gain: '<S35>/Gain1' */
      StandSpeed_Balance_DW.Delay_DSTATE_j = -20.0;
    }
     ...
     *  Gain: '<S34>/Gain'
     *  Gain: '<S37>/Gain'
     *  ManualSwitch: '<S34>/Manual Switch2'
     ...
     *  Store in Global RAM
     */
    StandSpeed_Balance_B.Add = (0.001 * StandSpeed_Balance_DW.Kp_speed *
      StandSpeed_Balance_DW.Delay_DSTATE_f +
      StandSpeed_Balance_DW.Delay_DSTATE_j) + 0.001 *
      StandSpeed_Balance_DW.Kd_speed * (StandSpeed_Balance_DW.Delay_DSTATE_f -
      StandSpeed_Balance_DW.UD_DSTATE_c);

    /* Update for UnitDelay: '<S38>/UD' incorporates:
     *  Delay: '<S36>/Delay'
     *
     * Block description for '<S38>/UD':
     *
     *  Store in Global RAM
     */
    StandSpeed_Balance_DW.UD_DSTATE_c = StandSpeed_Balance_DW.Delay_DSTATE_f;
  }
  ...
  /* DataStoreRead: '<Root>/Data Store Read10' incorporates:
   *  DataStoreWrite: '<Root>/Data Store Write7'
   *  Delay: '<S9>/Delay One Step'
   */
  StandSpeed_Balance_B.DataStoreRead10 =
   ...
   *  Delay: '<S8>/Delay One Step'
   */
  StandSpeed_Balance_B.DataStoreRead8 =
  ...
  if (rtb_Compare_g) {
    ...
    if (tmp > 4000) {
      ...
      rtb_Add_g3 = 20972.0 * (real_T)StandSpeed_Balance_B.angle[1] *
        4.76837158203125E-7;
    }
     ...
     *  Sum: '<S7>/Add1'
     */
    StandSpeed_Balance_B.Add_h = ((StandSpeed_Balance_B.Add +
      StandSpeed_Balance_DW.machine_mid) - rtb_Add_g3) *
      StandSpeed_Balance_DW.Kp_angle + 26214.0 * (real_T)
      StandSpeed_Balance_B.anglev[0] * 3.814697265625E-6 *
      StandSpeed_Balance_DW.Kd_angle;
  }
  ...
  if (StandSpeed_Balance_B.Add_h > 2048.0) {
    ...
    rtb_Add_g3 = StandSpeed_Balance_B.Add_h;
  }

  rtb_Add_g3 = floor(rtb_Add_g3);
  if (rtIsNaN(rtb_Add_g3)) {
    rtb_Add_g3 = 0.0;
  } else {
    rtb_Add_g3 = fmod(rtb_Add_g3, 65536.0);
  }

  /* Switch: '<S13>/Switch1' incorporates:
   *  Saturate: '<Root>/Saturation3'
   */
  StandSpeed_Balance_B.Saturation = (int16_T)(rtb_Add_g3 < 0.0 ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-rtb_Add_g3 : (int32_T)(int16_T)(uint16_T)
    rtb_Add_g3);
  ...
  StandSpeed_Balance_B.DataTypeConversion4 = StandSpeed_Balance_B.Saturation;
   ...
   *  Saturate: '<Root>/Saturation2'
   */
  StandSpeed_Balance_B.Saturation1 = (int16_T)(rtb_Add_g3 < 0.0 ? (int32_T)
    (int16_T)-(int16_T)(uint16_T)-rtb_Add_g3 : (int32_T)(int16_T)(uint16_T)
    rtb_Add_g3);
   ...
   *  Delay: '<S8>/Delay One Step'
   */
  rtb_Add1_h = (real32_T)StandSpeed_Balance_B.Saturation -
    StandSpeed_Balance_DW.DelayOneStep_DSTATE;
   ...
   */
  StandSpeed_Balance_DW.Delay_DSTATE_a += (real32_T)(0.03 * rtb_Add1_h);
   ...
   *  Store in Global RAM
   */
  rtb_Add_g3 = (7.0 * rtb_Add1_h + StandSpeed_Balance_DW.Delay_DSTATE_a) +
    (rtb_Add1_h - StandSpeed_Balance_DW.UD_DSTATE) * 5.0;
  ...
  if (StandSpeed_Balance_DW.DelayOneStep_DSTATE > -30.0F) {
    ...
    if (StandSpeed_Balance_DW.DelayOneStep_DSTATE > 30.0F) {
      ...
      if (rtb_Add_g3 > 0.0) {
        rtb_Add_g3 = floor(rtb_Add_g3);
        if (rtIsInf(rtb_Add_g3)) {
          /* Switch: '<S13>/Switch1' */
          StandSpeed_Balance_B.Saturation = 0;
        } else {
          /* Switch: '<S13>/Switch1' */
          StandSpeed_Balance_B.Saturation = (int16_T)(int32_T)fmod(rtb_Add_g3,
            65536.0);
        }
      } else {
        /* Switch: '<S13>/Switch1' incorporates:
      ...
      rtb_Add_g3 = floor(rtb_Add_g3);
      if (rtIsNaN(rtb_Add_g3) || rtIsInf(rtb_Add_g3)) {
        rtb_Add_g3 = 0.0;
      } else {
        rtb_Add_g3 = fmod(rtb_Add_g3, 65536.0);
      }
   ...
   *  Delay: '<S9>/Delay One Step'
   */
  rtb_Add1_d = (real32_T)StandSpeed_Balance_B.Saturation1 -
    StandSpeed_Balance_DW.DelayOneStep_DSTATE_b;
   ...
   */
  StandSpeed_Balance_DW.Delay_DSTATE += (real32_T)(0.03 * rtb_Add1_d);
   ...
   *  Store in Global RAM
   */
  rtb_Add_g3 = (7.0 * rtb_Add1_d + StandSpeed_Balance_DW.Delay_DSTATE) +
    (rtb_Add1_d - StandSpeed_Balance_DW.UD_DSTATE_o) * 4.0;
    ...
    if (StandSpeed_Balance_DW.DelayOneStep_DSTATE_b > 30.0F) {
      ...
      if (rtb_Add_g3 > 0.0) {
        ...
        if (rtIsInf(rtb_Add_g3)) {
          ...
          /* Switch: '<S14>/Switch1' */
          StandSpeed_Balance_B.Saturation1 = (int16_T)(int32_T)fmod(rtb_Add_g3,
            65536.0);
        }
      } else {
        /* Switch: '<S14>/Switch1' incorporates:
  ...
  StandSpeed_Balance_DW.Kp_angle = StandSpeed_Balance_B.DataLinkInput_o6;

  /* DataStoreWrite: '<Root>/Data Store Write9' */
  StandSpeed_Balance_DW.Kd_angle = StandSpeed_Balance_B.DataLinkInput_o7;
   ...
   *  Store in Global RAM
   */
  StandSpeed_Balance_DW.UD_DSTATE = rtb_Add1_h;
   ...
   *  Store in Global RAM
   */
  StandSpeed_Balance_DW.UD_DSTATE_o = rtb_Add1_d;
}

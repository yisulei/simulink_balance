...
typedef struct {
  ...
  real32_T DataStoreRead8;             /* '<Root>/Data Store Read8' */
...
typedef struct {
  ...
  real_T Delay_DSTATE_j;               /* '<S35>/Delay' */
  ...
  real32_T Delay_DSTATE_f;             /* '<S36>/Delay' */
  real32_T UD_DSTATE_c;                /* '<S38>/UD' */
  int32_T Delay_DSTATE_e[19];          /* '<S11>/Delay' */
  int32_T Delay1_DSTATE[19];           /* '<S11>/Delay1' */
  real32_T Kp_angle;                   /* '<Root>/Data Store Memory' */
  ...
  real32_T Kd_angle;                   /* '<Root>/Data Store Memory2' */
 ...
 * '<S33>'  : 'StandSpeed_Balance/speedPID_motor/Subsystem2'
 * '<S34>'  : 'StandSpeed_Balance/speedPID_motor/Subsystem2/D'
 * '<S35>'  : 'StandSpeed_Balance/speedPID_motor/Subsystem2/I'
 * '<S36>'  : 'StandSpeed_Balance/speedPID_motor/Subsystem2/LowFilter'
 * '<S37>'  : 'StandSpeed_Balance/speedPID_motor/Subsystem2/P'
 * '<S38>'  : 'StandSpeed_Balance/speedPID_motor/Subsystem2/D/Difference'
 */

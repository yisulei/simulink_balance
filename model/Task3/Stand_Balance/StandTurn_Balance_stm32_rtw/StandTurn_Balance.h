...
typedef struct {
  ...
  real32_T Divide;                     /* '<S17>/Divide' */
  real32_T Divide1;                    /* '<S17>/Divide1' */
...
typedef struct {
  ...
  real_T Delay_DSTATE_i;               /* '<S46>/Delay' */
  real_T Delay_DSTATE_n;               /* '<S42>/Delay' */
  real_T flag;                         /* '<Root>/Data Store Memory10' */
  real32_T DelayOneStep_DSTATE;        /* '<S13>/Delay One Step' */
  real32_T DelayOneStep_DSTATE_d;      /* '<S14>/Delay One Step' */
  real32_T UD_DSTATE;                  /* '<S36>/UD' */
  real32_T Delay_DSTATE_g;             /* '<S38>/Delay' */
  real32_T UD_DSTATE_k;                /* '<S40>/UD' */
  real32_T UD_DSTATE_o;                /* '<S48>/UD' */
  int32_T Delay_DSTATE_o[19];          /* '<S17>/Delay' */
  int32_T Delay1_DSTATE[19];           /* '<S17>/Delay1' */
 ...
 * '<S11>'  : 'StandTurn_Balance/Subsystem'
 * '<S12>'  : 'StandTurn_Balance/anglePID'
 * '<S13>'  : 'StandTurn_Balance/currentFilter_motor1'
 * '<S14>'  : 'StandTurn_Balance/currentFilter_motor2'
 * '<S15>'  : 'StandTurn_Balance/currentPID'
 * '<S16>'  : 'StandTurn_Balance/currentPID_motor1'
 * '<S17>'  : 'StandTurn_Balance/encoder to rpm'
 * '<S18>'  : 'StandTurn_Balance/speedPID_motor'
 ...
 * '<S41>'  : 'StandTurn_Balance/currentPID_motor1/D'
 * '<S42>'  : 'StandTurn_Balance/currentPID_motor1/I'
 * '<S43>'  : 'StandTurn_Balance/currentPID_motor1/P'
 * '<S44>'  : 'StandTurn_Balance/speedPID_motor/Subsystem2'
 * '<S45>'  : 'StandTurn_Balance/speedPID_motor/Subsystem2/D'
 * '<S46>'  : 'StandTurn_Balance/speedPID_motor/Subsystem2/I'
 * '<S47>'  : 'StandTurn_Balance/speedPID_motor/Subsystem2/P'
 * '<S48>'  : 'StandTurn_Balance/speedPID_motor/Subsystem2/D/Difference'
 */

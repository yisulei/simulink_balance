...
void StandTurn_Balance_step(void)
{
  ...
  /*Output Data*/
  DataLink_UpFrameData.data[0].point= StandTurn_Balance_B.DataTypeConversion;
  ...
  if (StandTurn_Balance_DW.Output_DSTATE_i == 1) {
    ...
    StandTurn_Balance_DW.Delay_DSTATE_i = ((real32_T)(0.001 *
      ...
      StandTurn_Balance_DW.Delay_DSTATE_i) * 0.995F;

    /* Saturate: '<S43>/Saturation2' */
    if (StandTurn_Balance_DW.Delay_DSTATE_i > 1500.0F) {
      /* Gain: '<S43>/Gain1' */
      StandTurn_Balance_DW.Delay_DSTATE_i = 1500.0F;
    } else if (StandTurn_Balance_DW.Delay_DSTATE_i < -1500.0F) {
      /* Gain: '<S43>/Gain1' */
      StandTurn_Balance_DW.Delay_DSTATE_i = -1500.0F;
    }
     ...
     *  Store in Global RAM
     */
    StandTurn_Balance_B.Add_b = (0.001 * StandTurn_Balance_DW.Kp_speed *
  ...
  if (StandTurn_Balance_DW.Output_DSTATE_a == 1) {
     ...
     *  Sum: '<S17>/Add1'
     */
    rtb_Add_a = (real_T)(StandTurn_Balance_DW.tar_yaw - rtb_Add1_m) *
      3.814697265625E-6;
    ...
    StandTurn_Balance_DW.Delay_DSTATE_n += (real32_T)(0.01 *
      StandTurn_Balance_DW.Ki_turn * rtb_Add_a);
     ...
     *  Product: '<S48>/Product'
     */
    StandTurn_Balance_B.Add = 26214.0 * (real_T)StandTurn_Balance_B.anglev[2] *
      3.814697265625E-6 * StandTurn_Balance_DW.Kd_turn + (rtb_Add_a *
      StandTurn_Balance_DW.Kp_turn + StandTurn_Balance_DW.Delay_DSTATE_n);
  }
  ...
  if (StandTurn_Balance_DW.Output_DSTATE_i5 == 1) {
     ...
     *  Sum: '<S11>/Add1'
     */
    StandTurn_Balance_B.Add_o = ((StandTurn_Balance_B.Add_b +
   ...
   */
  StandTurn_Balance_B.DataTypeConversion = (real32_T)
    StandTurn_Balance_DW.tar_yaw * 3.81469727E-6F;
  ...
  /* Sum: '<Root>/Add2' */
  rtb_Add_a = StandTurn_Balance_B.Add + StandTurn_Balance_B.Add_o;
  ...
  /* Sum: '<Root>/Add3' */
  rtb_Add_a = StandTurn_Balance_B.Add_o - StandTurn_Balance_B.Add;
  ...
  StandTurn_Balance_DW.Kp_turn = StandTurn_Balance_B.DataLinkInput_o1;

  /* DataStoreWrite: '<Root>/Data Store Write2' */
  StandTurn_Balance_DW.Ki_turn = StandTurn_Balance_B.DataLinkInput_o2;

  /* DataStoreWrite: '<Root>/Data Store Write3' */
  StandTurn_Balance_DW.Kd_turn = StandTurn_Balance_B.DataLinkInput_o3;

...
typedef struct {
  ...
  real_T Delay_DSTATE_a;               /* '<S44>/Delay' */
  real_T UD_DSTATE;                    /* '<S47>/UD' */
  real_T UD_DSTATE_o;                  /* '<S55>/UD' */
  ...
  real32_T Delay_DSTATE_n;             /* '<S57>/Delay' */
  real32_T Delay_DSTATE_i;             /* '<S53>/Delay' */
 ...
 * Block '<S52>/Manual Switch2' : Eliminated due to constant selection input
 ...
 * Block '<S56>/Manual Switch2' : Eliminated due to constant selection input
 * Block '<S57>/Manual Switch1' : Eliminated due to constant selection input
 * Block '<S58>/Manual Switch' : Eliminated due to constant selection input
 ...
 * '<S16>'  : 'Follow_Balance/lenth to speed'
 * '<S17>'  : 'Follow_Balance/speedPID_motor'
 * '<S18>'  : 'Follow_Balance/turnPID'
 ...
 * '<S42>'  : 'Follow_Balance/lenth to speed/D'
 * '<S43>'  : 'Follow_Balance/lenth to speed/Enabled Subsystem'
 * '<S44>'  : 'Follow_Balance/lenth to speed/I'
 * '<S45>'  : 'Follow_Balance/lenth to speed/P'
 * '<S46>'  : 'Follow_Balance/lenth to speed/Subsystem'
 * '<S47>'  : 'Follow_Balance/lenth to speed/D/Difference'
 * '<S48>'  : 'Follow_Balance/lenth to speed/Subsystem/Enabled Subsystem'
 * '<S49>'  : 'Follow_Balance/lenth to speed/Subsystem/Enabled Subsystem1'
 * '<S50>'  : 'Follow_Balance/lenth to speed/Subsystem/Enabled Subsystem2'
 * '<S51>'  : 'Follow_Balance/speedPID_motor/Subsystem2'
 * '<S52>'  : 'Follow_Balance/speedPID_motor/Subsystem2/D'
 * '<S53>'  : 'Follow_Balance/speedPID_motor/Subsystem2/I'
 * '<S54>'  : 'Follow_Balance/speedPID_motor/Subsystem2/P'
 * '<S55>'  : 'Follow_Balance/speedPID_motor/Subsystem2/D/Difference'
 * '<S56>'  : 'Follow_Balance/turnPID/D'
 * '<S57>'  : 'Follow_Balance/turnPID/I'
 * '<S58>'  : 'Follow_Balance/turnPID/P'
 */

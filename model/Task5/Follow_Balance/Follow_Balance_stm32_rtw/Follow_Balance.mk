...
MASTER_ANCHOR_DIR    = 
START_DIR            = D:\BaiduSyncdisk\000IFR\2022Balance\model\Task5\Follow_Balance
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
NUMST                = 1
TID01EQ              = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)\Follow_Balance_stm32_rtw \
	-I$(MATLAB_ROOT)\extern\include \
	-I$(MATLAB_ROOT)\simulink\include \
	-I$(MATLAB_ROOT)\rtw\c\src \
...
JLINK_PATH = D:\software\MDK529\JLink_V644g#powershell下使用此语句
